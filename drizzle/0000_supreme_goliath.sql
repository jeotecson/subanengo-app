...
CREATE TABLE "user_progress" (
	...
	"user_image_src" text DEFAULT '/SubanenGo.png' NOT NULL,
...
ALTER TABLE "vocabulary" ADD CONSTRAINT "vocabulary_unit_id_units_id_fk" FOREIGN KEY ("unit_id") REFERENCES "public"."units"("id") ON DELETE cascade ON UPDATE no action;